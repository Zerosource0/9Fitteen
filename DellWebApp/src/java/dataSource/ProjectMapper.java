...
class ProjectMapper {
    ...
    protected ArrayList<Partner> getPartnerInfo() {
    ...
    ArrayList<String> getStateNames() {
    ...
    ArrayList<PersonType> getPersonTypes() {
    ...
    ArrayList<Project> getProjects(int partnerID) {
    ...
    ArrayList<Project> getProjectsMyAction(int partnerID) {
        System.out.println("PM partnerID: " + partnerID);
        ArrayList<Project> projects = new ArrayList<>();
    ...
    ArrayList<Project> getProjectsMyAction() {
        ArrayList<Project> projects = new ArrayList<>();
    ...
    boolean createStateChange(Project p, int personID) {
        int rowsInserted = 0;
    ...
    boolean updateProjectState(Project p) {
        int rowsUpdated = 0;
    ...
    Person createPersonClass(int id) {
    ...
    String getPassword(int personID) {
    ...
    boolean changePassword(String password, int personID) {
        int rowsUpdated = 0;
    ...
    ArrayList<Comment> getComments(int projectID) {
    ...
    boolean saveComment(Project p, int personID, String comment) {
        int rowsInserted = 0;
    ...
    int getNumberOfPoe(int projectID) {
        int entries = 0;
    ...
    ArrayList<PoeFile> getPoeFiles(int projectID) {
    ...
    ArrayList<String> getPoeFileList(int projectID) {
    ...
    PoeFile getPoeFile(int projectID, int index) {
        PoeFile file = null;
    ...
    ArrayList<byte[]> getImage(int projectID) {
    ...
    boolean upload(int projectID, int projectStateID, InputStream inputStream, String fileName) {
        int rowsInserted = 0;
        int lastDot = 0;
